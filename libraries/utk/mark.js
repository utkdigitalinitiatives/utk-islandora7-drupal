...
jQuery(document).ready(function () {
    ...
    if (collectionname == '/collections/rfjcollection') {
        jQuery(("option[value='gsmrc:rfj']")).prependTo("#edit-collection-select");
        jQuery(("option[value='gsmrc:rfj']")).attr('selected', 'selected');
    }
